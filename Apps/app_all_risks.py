...
if uploaded_shp:
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        if shp_file:
            ...
            dry_season_1stmonth = st.number_input("First month of dry season", min_value=1, max_value=12, value=11)
            dry_season_lastmonth = st.number_input("Last month of dry season",  min_value=1, max_value=12, value=5)
            wet_season_1stmonth = st.number_input("First month of wet season", min_value=1, max_value=12, value=6)
            wet_season_lastmonth = st.number_input("Last month of wet season", min_value=1, max_value=12, value=10)

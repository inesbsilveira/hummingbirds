...
if uploaded_shp:
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        if shp_file:
            ...
            dry_season_1stmonth = st.number_input("First month of dry season", options=list(range(1,13)), index=10)
            dry_season_lastmonth = st.number_input("Last month of dry season",  options=list(range(1,13)), index=4)
            wet_season_1stmonth = st.number_input("First month of wet season", options=list(range(1,13)), index=5)
            wet_season_lastmonth = st.number_input("Last month of wet season", options=list(range(1,13)), index=9)
